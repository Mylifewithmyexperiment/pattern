...
public class OrderPreviewItemsAdapter extends BaseMainAdpter {
    private ArrayList<CartItem> itemList = new ArrayList<>();

    public OrderPreviewItemsAdapter(Context context, OnRecyclerViewItemClickListener<CartItem> recyclerViewItemClickListener) {
