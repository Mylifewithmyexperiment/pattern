...
public  class UserSignUpWsDTO  implements Serializable {
	...
	private String parentCustomerUId;
...
//	private UTMParameterWsDTO utmParameters;
	...
	public String getParentCustomerUId() {
		return parentCustomerUId;
	}

	public void setParentCustomerUId(String parentCustomerUId) {
		this.parentCustomerUId = parentCustomerUId;
	}
